...
I can also assist with advanced configurations, integrations, and other related topics. How can I assist you today?`,
      timestamp: new Date()
    }
  ]);
      ...
      <header className="bg-white border-b">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Ask me anything about Segment, mParticle, Lytics, or Zeotap, including advanced configurations and integrations.</p>
          </div>
        </div>
      </header>
